...
\begingroup%
  ...
  \begin{picture}(1,1)%
    ...
    \put(0,0){\includegraphics[width=\unitlength,page=1]{practices/1_pr/source/pr1_4.pdf}}%
    ...
    \put(0,0){\includegraphics[width=\unitlength,page=2]{practices/1_pr/source/pr1_4.pdf}}%
  \end{picture}%
  }
\endgroup%
